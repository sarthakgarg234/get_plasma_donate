...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li><a href="#plasma_therapy" class="smoothScroll">Plasma Therapy</a></li>
                    </ul>
               </div>
     ...
     <section id="home">
          ...
          <!-- Who Can Donate -->
     <section id="who_can_donate">
          <div class="container">
          <div class="row">

                    <div class="col-md-12 col-sm-12">
                         <div class="about-info">
                              <h2>Donor Eligibility for Plasma Donation</h2>
                              ...
                              By becoming a plasma donor, with your priceless plasma, you can give a new hope of life to the corona patient!</h5>
                         </div>
                    </div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="about-info">
                              <h2>You CAN donate plasma if:</h2>

                              <h5>You are between 18-60 years old.</h5>

                              <h5>You were tested positive for COVID-19.</h5>

                              <h5>You have fully recovered and are free of symptoms for 14 days.</h5>
                         </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="about-info">
                              <h2>You cannot donate plasma if:</h2>
                              <h5>Your weight is less than 50 kg.</h5>
                              <h5>You are a Cancer Survivor.</h5>
                              <h5>Females who have ever been pregnant</h5>
                              <h5>You have chronic kidney/heart/lung or liver disease.</h5>
                    ...
                    <div class="col-md-12 col-sm-12">
                         <div class="about-info">
                              ...
                              <figure>
                                   ...
                                   <figcaption>
                                        <h3>Website will displays donors information</h3>
                    ...
                    <div class="col-md-12 col-sm-12">
                         <form id="contact-form" role="form" action="save_donor_information.php" method="post">
                              <div class="section-title">
                                   <h2>Please Enter Donor Details Below</h2>
                              </div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <div class="footer-info">
                              ...
                              <address>
                                   <p><a href="mailto:getplasmadonor@gmail.com">getplasmadonor@gmail.com</a></p>
                              </address>
                         </div>
                    </div>
